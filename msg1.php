...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <?php
                ...
                if($messageRe->num_rows > 0){
                    ...
                    while($row = $messageRe->fetch_assoc()){
                        ...
                        echo " <a href=\"clicklike_mem.php?id=".$row['id']."\" class=\"btn btn-default btn-xs likesign1\">LIKE</a> ".$cl;
                        
                        echo "<input type=\"hidden\" id=\"inid2\" class=\"unlikesign\" value=".$input_unlike.">";
                        echo " <a href=\"clickunlike_mem.php?id=".$row['id']."\" class=\"btn btn-default btn-xs unlikesign1\">UNLIKE</a> ".$cul;
                    ...
                    echo "<li><a href='msg.php?page=1'>首頁</a></li>";
                    for ($i=1; $i<=$total_pages; $i++) { 
                        echo "<li><a href='msg.php?page=".$i."' data-pageid='".$i."'>".$i."</a></li>";
                    }; 
                    echo "<li><a href='msg.php?page=$total_pages'>末頁</a></li>";
                    echo "</ul>";
                }else{
                    //沒有留言的話
            ...
            <h4>新增留言</h4>
            <form id="form" name="form" action="msg_add.php" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="form1" name="form1" action="msg_add_rep.php" method="post" enctype="multipart/form-data">        
