...
<html>
    <head>
        ...
        <meta http-equiv="Content_data-Type" content_data="text/html; charset=utf-8" />
            ...
            <?php
                ...
                if($messageRe->num_rows > 0){
                    ...
                    while($row = $messageRe->fetch_assoc()){
                        ...
                        if ($row['img_path']) {
                            echo "<div class=\"panel-body change \"><div><img src=".$row['img_path']."></div><div>".$row['content_data']."</div></div>";
                        } else {
                            echo "<div class=\"panel-body change \">".$row['content_data']."</div>";
                        }
                        ...
                        if($replyRe->num_rows > 0){
                            ...
                            while($replyRow = $replyRe->fetch_assoc()){
                                ...
                                if ($replyRow['img_path']) {
                                    ...
                                    echo "<p>".$replyRow['content_data']."</p>";
                                    echo "</td>";
                                } else {
                                    echo "<td width=\"77%\">".$replyRow['content_data']."</td>";
                                }
