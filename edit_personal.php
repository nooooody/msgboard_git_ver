        ...
        <div class="container">
          <div class="col-md-6 col-md-offset-3">
              <form id="editform" name="editform" method="POST">
                  <input id="pass1" name="pass1" class="form-control input-lg" type="password" placeholder="輸入姓名(Name)"/>
                  <p id="p1" name="p1" style="color: red; font-size: 14px; opacity: 0; margin: 0" >GodMartin</p>
                  <input id="pass2" name="pass2" class="form-control input-lg" type="password" placeholder="輸入暱稱(Nick)"/>
